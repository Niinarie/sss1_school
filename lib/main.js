...
window.onload = function () {
  ...
  var createSelect = function createSelect(array) {
  ...
  var filterByCategory = function filterByCategory(cat, array) {
    container.innerHTML = '';
    if (cat !== 'All') {
  ...
  var fillCards = function fillCards(array) {
  ...
  var displayModal = function displayModal(id) {
    var cat = catData(id);
  ...
  var catData = function catData(id) {
